...
namespace MijemApplication.Controllers
{
    public class ContactTypesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "TypeID,TypeName,TypeDescription")] ContactType contactType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TypeID,TypeName,TypeDescription")] ContactType contactType)
        {
            if (ModelState.IsValid)
            {
